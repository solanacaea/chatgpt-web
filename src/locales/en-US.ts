export default {
  ...
  chat: {
    ...
    turnOnContext: 'Enable Context', //'In the current mode, sending messages will carry previous chat records.',
    turnOffContext: 'Disable Context', //'In the current mode, sending messages will not carry previous chat records.',
  ...
  setting: {
    ...
    name: 'Name',
    pwdPre: 'Previous Password',
    pwdNew: 'New Password',
    pwdConfirm: 'Confirm Password',
    description: 'Description',
    pwdPrePlaceholder: 'Previous password',
    pwdNewPlaceholder: 'New password',
    pwdConfirmPlaceholder: 'New password again',
    role: 'Role',
  ...
  message: {
    ...
    inconstantPwd: '2 passwords differ',
