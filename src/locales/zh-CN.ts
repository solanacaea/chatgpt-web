export default {
  ...
  chat: {
    ...
    exportFailed: '保存失败',
    usingContext: '上下文模式',
    turnOnContext: '开启上下文模式', //当前模式下, 发送消息会携带之前的聊天记录
    turnOffContext: '关闭上下文模式', //'当前模式下, 发送消息不会携带之前的聊天记录',
    deleteMessage: '删除消息',
  ...
  setting: {
    ...
    pwdNew: '新密码',
    pwdConfirm: '确认密码',
    pwdPrePlaceholder: '请填写旧密码',
    pwdNewPlaceholder: '请输入新密码',
    pwdConfirmPlaceholder: '请再次输入新密码',
    description: '描述',
    role: '角色设定',
